package org.vaadin.addons.filteringgrid.demo;
...
import org.vaadin.addons.filteringgrid.demo.data.Person;
import org.vaadin.addons.filteringgrid.demo.data.Person.Continent;
import org.vaadin.addons.filteringgrid.demo.data.PersonService;
...
@Theme("mytheme")
public class FilterGridDemo extends UI {
    ...
    @VaadinServletConfiguration(ui = FilterGridDemo.class, productionMode = false)
